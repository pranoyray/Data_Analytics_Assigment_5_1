#Data Analytics Assignment 5.1 - Session 5

#Q1. If Z is norm (mean = 0, sd = 1)
#Find P(Z > 2.64)
#Find P(|Z| > 1.39)
...
# Therefore, we fail to reject the null hypothesis that the true proportion of students 
# admitted to graduate school is less than 40% and 
